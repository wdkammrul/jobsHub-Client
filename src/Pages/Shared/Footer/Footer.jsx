const Footer = () => {
    return (
        <footer className="footer  mb-10 mt-32 p-10 bg-base-200 text-base-content rounded-lg w-[400px] md:w-[740px] lg:w-full mx-auto">
            <nav className="lg:flex justify-center items-center gap-7">
                <img className="w-32 rounded-full" src="https://i.ibb.co/93n28NM/1517027541750.jpg" alt="" />
                <div>
                    <p >Address: 32, Sagunbaghicha </p>
                    <p className="mt-2"> Dhaka, Bangladesh</p>
                    <p className="">Copyright © 2023 - All right reserved by <span className="btn btn-secondary">JobsHub</span></p>
                </div>
            </nav>
            <nav>
